"""
This file contaons all models designed for core app. It contains both default django models and 
...
class User(models.Model):
    ...
    user_status = models.ForeignKey('UserStatus', models.DO_NOTHING)
