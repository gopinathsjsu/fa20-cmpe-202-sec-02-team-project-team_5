...
class CreateListingSerializer(serializers.Serializer):
    ...
    # floor_type = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    sqft_area = serializers.IntegerField()
    ...
    # parking_space_type = serializers.CharField(required=False, allow_null=True, allow_blank=True)
